...
def main():
    adj_matrix_AB = read_adjacency_matrix_from_csv('setAB_WorstCase_Fail.csv');
    print("Matrix AB:");
    print(adj_matrix_AB);
    adj_matrix_BC = read_adjacency_matrix_from_csv('setBC_WorstCase_Fail.csv');
    print("Matrix BC:");
    print(adj_matrix_BC);
    adj_matrix_CA = read_adjacency_matrix_from_csv('setCA_WorstCase_Fail.csv');
    print("Matrix CA:");
    ...
    if(np.all(x==0)):
        ...
        end_time = time.time();
        print("Total time take to compute x ->",end_time-start_time," secs");
        return;
